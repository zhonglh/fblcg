package com.fullbloom.framework.core.exception;
...
import com.fullbloom.framework.util.JSONHelper;
...
public class GlobalExceptionResolver implements HandlerExceptionResolver {
	...
	private boolean isAjax(HttpServletRequest request, HttpServletResponse response) {
		String XRequ = request.getHeader("X-Requested-With");
		return StringUtils.isNotEmpty(XRequ);
	}
