...
public class BusinessUtil {
	 ...
	 * @return
	 */
	public static String getAccountAttrMappingBatchNo() {
	...
	public static String processNumber(boolean isNumber,String data){
		...
		if(data != null){
			if(data.indexOf(".")>0 &&data.indexOf(",")<=0){
				...
				if(!text.isEmpty()){
					if(!BusinessUtil.match("^[0]{1,}$",text)) return data;
				}
	...
	public static String processJson(String val){
		...
		else return val.replace("\\","\\\\").replace("\"", "\\\"");
	}
	...
	public static void main(String[] args){
		System.out.println( processNumber("121qqq212") );
		//System.out.println(BusinessUtil.match(BusinessConstant.s+"{1,100}", "非存款类金融机构存放款项—活") );
