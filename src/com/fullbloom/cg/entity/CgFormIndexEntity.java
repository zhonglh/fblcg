...
public class CgFormIndexEntity extends IdEntity implements java.io.Serializable {
	...
	private List<CgFormFieldEntity> fields;
	...
	@Transient
	@JsonIgnore
	public List<CgFormFieldEntity> getFields() {
		return fields;
	}

	public void setFields(List<CgFormFieldEntity> fields) {
		this.fields = fields;
	}
